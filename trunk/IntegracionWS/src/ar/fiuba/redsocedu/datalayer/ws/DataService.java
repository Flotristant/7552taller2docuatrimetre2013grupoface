 ...
 * 
 */
@WebServiceClient(name = "DataService", targetNamespace = "http://ws.datalayer.redsocedu.fiuba.ar/", wsdlLocation = "http://localhost:8080/rsedatos/rsedatos?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/rsedatos/rsedatos?wsdl");
