 ...
 * 
 */
@WebServiceClient(name = "DataService", targetNamespace = "http://ws.datalayer.redsocedu.fiuba.ar/", wsdlLocation = "http://200.68.65.249:58080/rsedatos/rsedatos?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DATASERVICE_QNAME = new QName("http://ws.datalayer.redsocedu.fiuba.ar/", "DataService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://200.68.65.249:58080/rsedatos/rsedatos?wsdl");
